...
pub enum DivergingSpace {
    #[doc = include_str!("../../docs/brbg.svg")]
    BrBg,

    #[doc = include_str!("../../docs/piyg.svg")]
    PiYg,

    #[doc = include_str!("../../docs/prgn.svg")]
    PrGn,

    #[doc = include_str!("../../docs/puor.svg")]
    PuOr,

    #[doc = include_str!("../../docs/rdbu.svg")]
    RdBu,

    #[doc = include_str!("../../docs/rdgy.svg")]
    RdGy,

    #[doc = include_str!("../../docs/rdylbu.svg")]
    RdYlBu,

    #[doc = include_str!("../../docs/rdylgn.svg")]
    RdYlGn,

    #[doc = include_str!("../../docs/spectral.svg")]
    Spectral,
}
