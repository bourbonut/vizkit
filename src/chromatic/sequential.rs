...
pub enum SequentialSpace {
    #[doc = include_str!("../../docs/blues.svg")]
    Blues,

    #[doc = include_str!("../../docs/greens.svg")]
    Greens,

    #[doc = include_str!("../../docs/greys.svg")]
    Greys,

    #[doc = include_str!("../../docs/oranges.svg")]
    Oranges,

    #[doc = include_str!("../../docs/purples.svg")]
    Purples,

    #[doc = include_str!("../../docs/reds.svg")]
    Reds,

    #[doc = include_str!("../../docs/bugn.svg")]
    BuGn,

    #[doc = include_str!("../../docs/bupu.svg")]
    BuPu,

    #[doc = include_str!("../../docs/gnbu.svg")]
    GnBu,

    #[doc = include_str!("../../docs/orrd.svg")]
    OrRd,

    #[doc = include_str!("../../docs/pubu.svg")]
    PuBu,

    #[doc = include_str!("../../docs/pubugn.svg")]
    PuBuGn,

    #[doc = include_str!("../../docs/purd.svg")]
    PuRd,

    #[doc = include_str!("../../docs/rdpu.svg")]
    RdPu,

    #[doc = include_str!("../../docs/ylgn.svg")]
    YlGn,

    #[doc = include_str!("../../docs/ylgnbu.svg")]
    YlGnBu,

    #[doc = include_str!("../../docs/ylorbr.svg")]
    YlOrBr,

    #[doc = include_str!("../../docs/ylorrd.svg")]
    YlOrRd,
}
